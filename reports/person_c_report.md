...
- **Config file**: `backend/config/ai_config.json` (JSON chosen to avoid extra deps; YAML can be added if needed).
  ...
  - `alpha_beta.depth`, `distance`, `candidate_limit`, `use_eval_cache`
- **Hyperparameter choices**:
  ...
  - Alpha-Beta speedups: optional eval-cache toggle plus a slightly tighter branching factor below the root.
...
| ---------- | ----- | ---------- | -------------- | --------- | ----- | -------------------- |
| Random     | –    | 44         | 1              | 0.158     | (7,2) | 74.60                |
| Greedy     | 1     | 44         | 44             | 2.624     | (4,4) | 5201.60              |
| Minimax    | 2     | 44         | 157            | 69.912    | (6,7) | 5022.40              |
| Alpha-Beta | 3     | 44         | 142            | 125.498   | (4,4) | 5201.60              |
...
- Alpha-Beta now prunes more aggressively (142 nodes vs. previous 228) and gains latency from caching toggle + tighter branching.
