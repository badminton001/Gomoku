"""Visualization Generation Script (Person E)
...
def plot_win_rate_comparison(win_rates, output_dir):
    ...
    print("✓ [2/15] Win rate comparison")
...
def plot_response_time_boxplot(data, time_stats, output_dir):
    ...
    print("✓ [3/15] Response time boxplot")
...
def plot_game_length_category(data, output_dir):
    ...
    print("✓ [11/15] Game length category")
    plt.close()
...
def main():
    ...
    # Load data
    print("📂 Loading data...")
    data, win_rates, time_stats, matchup_matrix, elo_ratings = load_data()
    print("✓ Data loaded\n")
    ...
    plot_matchup_heatmap(matchup_matrix, output_dir)
    plot_win_rate_comparison(win_rates, output_dir)
    plot_response_time_boxplot(data, time_stats, output_dir)
    plot_elo_ratings(elo_ratings, output_dir)
    plot_move_distribution(data, output_dir)
    
    # Matplotlib static charts (10)
    plot_algorithm_ranking(win_rates, output_dir)
    plot_time_vs_winrate(win_rates, time_stats, output_dir)
    plot_correlation_matrix(data, output_dir)
    plot_win_loss_stats(win_rates, output_dir)
    plot_time_distribution(time_stats, output_dir)
    plot_game_length_category(data, output_dir)
    plot_algorithm_winrate_trend(data, output_dir)
    plot_performance_radar(win_rates, time_stats, output_dir)
