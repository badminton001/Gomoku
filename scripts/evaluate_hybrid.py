...
def main():
    ...
    possible_models = [
        "models/sl_model_kaggle.pth",        # Kaggle Priority
        "models/sl_model_v1_finetuned.pth",  # Local Finetune
        "models/sl_model_v1.pth"             # Base
    ]
    
    model_path = "models/sl_model_v1.pth" # Fallback
